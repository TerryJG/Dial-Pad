// Reads DTMF input data from web_audio.js and displays it
var input = '';
var output = $('.output');
...
function formatPhoneNumber(value) {
  ...
  const input = value.replace(/[^\d*#]/g, ''); // Remove characters that are not digits, '*', or '#' from input
...
// Phone number format: "000-0000-00" | Could be used for secret numbers
